...
public class DBConnection {
    ...
    private static final String URL = "jdbc:sqlserver://localhost:1434;databaseName=NewwSalesDB;integratedSecurity=true;encrypt=false;trustServerCertificate=true";
